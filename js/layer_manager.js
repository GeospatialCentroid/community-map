...
//        analytics_manager.track_event("side_bar","remove_layer","layer_id",_resource_id)
    ...
    add_to_map_tab(_resource_id,_z){
        ...
        console.log("title col",filter_manager["title_col"])
    ...
    if (service_method._class=="distortableImageOverlay"){
      ...
      if (service_method._method=="ajax"){
         ...
         if(layer_obj){
             ...
             this.show_csv_data(layer_obj.layer_obj,_resource_id,item_ids);
             return
          }else{
...
//             }
  ...
  show_ajax(url,layer_obj,_resource_id,data){
        var $this = this
  ...
  create_geo_feature(feature,_resource_id,layer_obj, layer,url,unique_id){
    ...
    console_log("Create geo feature",geo)
  ...
  show_csv_data(layer_obj,_resource_id,item_ids){
    var $this=this
 ...
 create_geo_avatar(feature, _resource_id, layer_obj, layer, url, unique_id) {
    ...
    var avatarIcon = L.divIcon({
        ...
        iconSize: [40, 40],       // Dimensions of the circle container [width, height]
        iconAnchor: [20, 20],     // Anchor point directly in the center of your 40x40 circle
